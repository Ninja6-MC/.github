...
requests, discussions, and the project Discord — and also applies when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
community leaders responsible for enforcement, through either of these private channels:

* **On Discord** — direct-message any 🏯 Sensei, ⚔️ Shinobi, or 🛡️ Guardian in the
  [Ninja6 server](https://discord.gg/KEHaeHC8FB). Those three roles are hoisted, so they
  are visible at the top of the member list.
* **On GitHub** — open a
  [private security advisory](https://github.com/Ninja6-MC/.github/security/advisories/new)
  on this repository. It reaches the same people privately. The form is written for
  vulnerabilities, but conduct reports are accepted there too; say so in the first line.

Do not report a concern in a public channel or a public issue. Reports are handled
privately among moderators.
